        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We are a team of passionate digital craftsmen, dedicated to
          ...
          <motion.div
            ...
            className="prose prose-lg max-w-3xl mx-auto text-gray-600 text-center"
          >
            <p className="mb-6">
              Founded in 2020, DigitalCraft has been at the forefront of digital
            ...
            <p>
              ...
              innovation, ensuring that every project we deliver not only meets
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              Meet the experts behind DigitalCraft
            </p>
          </motion.div>
